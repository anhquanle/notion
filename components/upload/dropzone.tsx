...
const DROPZONE_VARIANTS = {
  base: "relative rounded-md p-4 w-full flex justify-center items-center flex-col cursor-pointer border-2 border-dashed border-muted-foreground transition-colors duration-200 ease-in-out hover:bg-red-500",
  active: "border-primary bg-red-100",
  disabled:
